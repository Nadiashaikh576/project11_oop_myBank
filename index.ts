...
const customers: Customer[] = [
    new Customer("Abdul", "Kareem", 40, "Male", 3002121212, accounts[0]),
    new Customer("Emaan", "Fatima", 25, "Female", 3003131313, accounts[1]),
    new Customer("Shaheer", "Ahmed", 30, "Male", 3004141414, accounts[2])
